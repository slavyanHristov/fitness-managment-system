...
const payload = ref({
  ...
  fee: foundMembership.value.fee,
  membershipTypeId: foundMembership.value.membershipTypeId,
  gymId: foundMembership.value.gymId,
});
...
<template>
  ...
  >
    ...
    >
      <header class="w-full py-6 mb-6 text-center border-b border-primaryBlue">
